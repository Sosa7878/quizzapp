...
function ResultPage() {
  ...
  useEffect(() => {
    // Check if we have result data from quiz submission
    if (location.state && location.state.resultData) {
      ...
      // Load latest result from backend
      loadLatestResult();
    }
  }, [location.state]);
        ...
        <div className="bg-white p-8 rounded shadow-md mb-6">
          ...
          <div className={`text-center p-6 rounded-lg mb-6 ${
            ...
            <h2 className={`text-2xl font-bold mb-2 ${
              ...
              {resultData.passed ? '🎉 URIME!' : '😔 NUK KALUAT'}
            </h2>
            <p className={`text-lg ${
              resultData.passed ? 'text-green-600' : 'text-red-600'
            }`}>
              {resultData.passed ? 'Ju kaluat testin me sukses!' : 'Nuk arritët të kaloni testin këtë herë. Vazhdoni të studijoni!'}
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
            ...
            <div className="text-center p-4 bg-gray-50 rounded-lg">
              ...
              <p className={`text-2xl font-bold ${
                ...
                {resultData.passed ? 'KALUAT' : 'NUK KALUAT'}
              </p>
            </div>
          </div>
